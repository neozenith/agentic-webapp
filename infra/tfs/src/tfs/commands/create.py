...
from tfs.config import bucket_for, environments_of, expected_prefix, layout_of, load_config, validate_config_shape
...
def cmd_create(args: Namespace) -> None:
    ...
    for environment in environments_of(base_config):
        rendered = _render(
            ...
            prefix=expected_prefix(stack_name, environment, layout=layout),
        )
