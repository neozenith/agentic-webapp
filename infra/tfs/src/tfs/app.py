...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_comment.add_argument(
        "--png-artifact-id", required=True, help="artifact-id output of the PNG upload-artifact step"
    )
    p_comment.add_argument(
        "--svg-artifact-id", required=True, help="artifact-id output of the SVG upload-artifact step"
    )
