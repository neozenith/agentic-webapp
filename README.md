...
| [`backend/`](backend) | FastAPI app: serves the SPA, proxies the agent, owns GCS + Firestore/BigQuery |
| [`agent/`](agent) | Google ADK agent sidecar; meters token usage via `after_model_callback` |
